...
class KillCounter implements IEventDispatcher
{
	var count:Int;
	...
	public function new()
	{
		addEvent('dead', somethingDied);
	}

	private function somethingDied(e:EventObject = null)
	{
		trace("death count is currently: "+(++count));
	}
